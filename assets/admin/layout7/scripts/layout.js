...
var Layout = function() {
    ...
    var resBreakpointMd = RKR.getResponsiveBreakpoint('md'); //992px
    var resBreakpointSm = RKR.getResponsiveBreakpoint('sm'); //768px
    ...
    return {
        ...
        getLayoutImgPath: function() {
            return RKR.getAssetsPath() + layoutImgPath;
        },

        getLayoutCssPath: function() {
            return RKR.getAssetsPath() + layoutCssPath;
        }
    };
